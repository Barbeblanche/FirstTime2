...
class Player
  ...
  def initialize(map, x, y)
    ...
    @standing = Gosu::Image.new("media/1.png")
    @walk1d = Gosu::Image.new("media/2.png")
    @walk2d = Gosu::Image.new("media/3.png")
    @jump = Gosu::Image.new("media/saut.png")
    @gliss = Gosu::Image.new("media/glissade.png")
  ...
  def update(move_x,i)
    ...
    if (move_x == 0)
      ...
      @cur_image = (Gosu.milliseconds / 175 % 2 == 0) ? @walk1d : @walk2d
    end
    if (@vy > 0)
      @cur_image = @jump
    end
...
class Map
  ...
  def initialize(filename)
    ...
    @tileset = Gosu::Image.load_tiles("media/tile2.png", 50, 50, :tileable => true)
